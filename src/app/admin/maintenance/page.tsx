...
export default function MaintenancePage() {
  return (
    <div className="absolute inset-0 z-[100] bg-[#000e23] text-white flex flex-col items-center justify-center p-6 antialiased">
      ...
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        <h1 className="font-headline text-2xl font-bold text-white">System Update in Progress</h1>
